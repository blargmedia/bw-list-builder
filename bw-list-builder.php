        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              bwlb_get_page_select('bwlb_manage_subscription_page_id', 'bwlb_manage_subscription_page_id', 0, 'id', '')
              . '
          ...
          <tr>
            ...
            <td>
              ' .
              // to return the html selector with the pages in the options
              bwlb_get_page_select('bwlb_confirmation_page_id', 'bwlb_confirmation_page_id', 0, 'id', '')
              . '
          ...
          <tr>
            ...
            <td>
              ' .
              // to return the html selector with the pages in the options
              bwlb_get_page_select('bwlb_reward_page_id', 'bwlb_reward_page_id', 0, 'id', '')
              . '
          ...
          <tr>
            <th scope="row">
              ...
              <td>');
                ...
                wp_editor('','bwlb_default_email_footer', array('textarea_rows'=>8)); // provides a WP edit box
          ...
          <tr>
            ...
            <td>
              <input type="number" name="bwlb_download_limit" value="0" class="" />
